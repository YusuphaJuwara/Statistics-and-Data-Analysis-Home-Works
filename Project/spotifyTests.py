...
y_kmeans = kmeans.fit_predict(standard_data)

ax.scatter(df_All['energy'],df_All['loudness'],df_All['acousticness'], 
            c=y_kmeans, cmap='viridis',
            edgecolor='k', s=40, alpha = 0.5)

#ax.scatter(df_All['energy'],df_All['loudness'],df_All['acousticness'])   
# plt.scatter(classic_dataset['energy'],classic_dataset['loudness'])
# plt.scatter(metal_dataset['energy'],metal_dataset['loudness'])
ax.set_xlabel('energy')
ax.set_ylabel('loudness (decibels)')
